...
export default function TeaserVideoPage() {
  ...
  const scenarioTeamMembers = [
    ...
    [
      {name: 'Sarah', role: 'Product Lead', color: 'bg-slate-600', borderColor: 'border-slate-600', bgColor: 'bg-slate-600/20'},
      {name: 'Marcus', role: 'CTO', color: 'bg-blue-600', borderColor: 'border-blue-600', bgColor: 'bg-blue-600/20'},
      {name: 'Elena', role: 'Designer', color: 'bg-orange-600', borderColor: 'border-orange-600', bgColor: 'bg-orange-600/20'},
    ],
    // Scenario 2: Goal-Aligned Discussions  
    [
      {name: 'Marcus', role: 'CTO', color: 'bg-blue-600', borderColor: 'border-blue-600', bgColor: 'bg-blue-600/20'},
      {name: 'Lisa', role: 'Marketing', color: 'bg-purple-600', borderColor: 'border-purple-600', bgColor: 'bg-purple-600/20'},
      {name: 'Ryan', role: 'Developer', color: 'bg-green-600', borderColor: 'border-green-600', bgColor: 'bg-green-600/20'},
    ],
    // Scenario 3: Decision Memory
    [
      {name: 'Elena', role: 'Designer', color: 'bg-orange-600', borderColor: 'border-orange-600', bgColor: 'bg-orange-600/20'},
      {name: 'Carlos', role: 'Engineer', color: 'bg-red-600', borderColor: 'border-red-600', bgColor: 'bg-red-600/20'},
      {name: 'Zoe', role: 'Developer', color: 'bg-yellow-600', borderColor: 'border-yellow-600', bgColor: 'bg-yellow-600/20'},
    ],
    // Scenario 4: Smart AI Intervention
    [
      {name: 'David', role: 'PM', color: 'bg-green-600', borderColor: 'border-green-600', bgColor: 'bg-green-600/20'},
      {name: 'Amy', role: 'Engineer', color: 'bg-pink-600', borderColor: 'border-pink-600', bgColor: 'bg-pink-600/20'},
      {name: 'Josh', role: 'Developer', color: 'bg-blue-500', borderColor: 'border-blue-500', bgColor: 'bg-blue-500/20'},
      {name: 'Sam', role: 'Developer', color: 'bg-teal-600', borderColor: 'border-teal-600', bgColor: 'bg-teal-600/20'},
    ],
    // Scenario 5: Context Preservation Across Time
    [
      {name: 'Mike Krieger', role: 'CPO', color: 'bg-indigo-600', borderColor: 'border-indigo-600', bgColor: 'bg-indigo-600/20'},
      {name: 'Jessica', role: 'Designer', color: 'bg-pink-500', borderColor: 'border-pink-500', bgColor: 'bg-pink-500/20'},
      {name: 'Tommy', role: 'Engineer', color: 'bg-cyan-600', borderColor: 'border-cyan-600', bgColor: 'bg-cyan-600/20'},
    ],
    // Scenario 6: Cross-Team Shared Intelligence
    [
      {name: 'Kevin Weil', role: 'VP Product', color: 'bg-purple-700', borderColor: 'border-purple-700', bgColor: 'bg-purple-700/20'},
      {name: 'Lisa Chen', role: 'Marketing', color: 'bg-purple-600', borderColor: 'border-purple-600', bgColor: 'bg-purple-600/20'},
      {name: 'Alex Rodriguez', role: 'Engineering', color: 'bg-red-600', borderColor: 'border-red-600', bgColor: 'bg-red-600/20'},
      {name: 'Sarah Kim', role: 'Support', color: 'bg-green-500', borderColor: 'border-green-500', bgColor: 'bg-green-500/20'},
    ],
    // Scenario 7: Preventing Knowledge Loss
    [
      {name: 'Alex', role: 'Engineer', color: 'bg-pink-600', borderColor: 'border-pink-600', bgColor: 'bg-pink-600/20'},
      {name: 'Dan', role: 'DevOps', color: 'bg-orange-500', borderColor: 'border-orange-500', bgColor: 'bg-orange-500/20'},
      {name: 'Sam', role: 'Backend', color: 'bg-teal-600', borderColor: 'border-teal-600', bgColor: 'bg-teal-600/20'},
    ],
    // Scenario 8: Intelligence Layer - Context Tracking
    [
      {name: 'Priya', role: 'Product', color: 'bg-violet-600', borderColor: 'border-violet-600', bgColor: 'bg-violet-600/20'},
      {name: 'Harper', role: 'Developer', color: 'bg-yellow-600', borderColor: 'border-yellow-600', bgColor: 'bg-yellow-600/20'},
      {name: 'Leo', role: 'Engineer', color: 'bg-blue-700', borderColor: 'border-blue-700', bgColor: 'bg-blue-700/20'},
    ],
    // Scenario 9: Multiplayer Chat - Shared Context
    [
      {name: 'Harper', role: 'Developer', color: 'bg-yellow-600', borderColor: 'border-yellow-600', bgColor: 'bg-yellow-600/20'},
      {name: 'Cole', role: 'Designer', color: 'bg-emerald-600', borderColor: 'border-emerald-600', bgColor: 'bg-emerald-600/20'},
      {name: 'Mira', role: 'Backend', color: 'bg-slate-600', borderColor: 'border-slate-600', bgColor: 'bg-slate-600/20'},
      {name: 'Leo', role: 'Mobile', color: 'bg-blue-700', borderColor: 'border-blue-700', bgColor: 'bg-blue-700/20'},
    ],
    // Scenario 10: Meeting Drift Prevention
    [
      {name: 'Dan', role: 'Team Lead', color: 'bg-orange-500', borderColor: 'border-orange-500', bgColor: 'bg-orange-500/20'},
      {name: 'Maya', role: 'Frontend', color: 'bg-rose-600', borderColor: 'border-rose-600', bgColor: 'bg-rose-600/20'},
      {name: 'Ryan', role: 'Backend', color: 'bg-green-600', borderColor: 'border-green-600', bgColor: 'bg-green-600/20'},
    ],
    // Scenario 11: Distributed Team Knowledge Sharing
    [
      {name: 'Elena', role: 'Designer', color: 'bg-orange-600', borderColor: 'border-orange-600', bgColor: 'bg-orange-600/20'},
      {name: 'Leo', role: 'Stockholm', color: 'bg-blue-700', borderColor: 'border-blue-700', bgColor: 'bg-blue-700/20'},
      {name: 'Josh', role: 'Tokyo', color: 'bg-blue-500', borderColor: 'border-blue-500', bgColor: 'bg-blue-500/20'},
    ],
  ];

  const currentTeamMembers = scenarioTeamMembers[currentScenario] || scenarioTeamMembers[0];
  ...
  const generateChannels = (primaryChannel: string) => {
    ...
    return [primaryChannel, ...baseChannels.filter(ch => ch !== primaryChannel)];
  };
    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 gap-4">
      ...
      <div className="flex flex-wrap items-center gap-4 text-white text-sm">
        <div className="flex items-center gap-2">
          <span>Scenario:</span>
          <span className="bg-white/20 px-2 py-1 rounded">{currentScenario + 1}/11</span>
        </div>
        <div className="flex items-center gap-2">
          <span>Mode:</span>
          <button
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            onChange={(e) => isMobile ? setMobileWidth(parseInt(e.target.value)) : setContainerWidth(parseInt(e.target.value))}
          ...
          <input
            ...
            onChange={(e) => isMobile ? setMobileHeight(parseInt(e.target.value)) : setContainerHeight(parseInt(e.target.value))}
            className="bg-white/20 text-white px-2 py-1 rounded w-16 text-center"
            min="300"
            max="1200"
          />
      ...
      {showControls && (
        <div className="bg-black/90 rounded-lg p-3 text-white text-sm backdrop-blur-sm border border-white/20">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-xs text-white/80">
            <div><kbd className="bg-white/20 px-1 rounded">N</kbd> Next scenario</div>
            <div><kbd className="bg-white/20 px-1 rounded">P</kbd> Previous scenario</div>
            <div><kbd className="bg-white/20 px-1 rounded">R</kbd> Restart current</div>
            <div><kbd className="bg-white/20 px-1 rounded">M</kbd> Toggle mobile view</div>
            <div><kbd className="bg-white/20 px-1 rounded">S</kbd> Toggle sidebar</div>
        ...
        <div className="h-full bg-black overflow-hidden relative">
          ...
          {isMobile && (
            <div className="absolute top-0 left-0 right-0 z-40 flex items-center justify-between p-4">
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 bg-white/10 border border-white/20 rounded-full text-white text-sm font-medium"
              >
                <span>Menu</span>
            ...
            <div className="absolute left-6 top-6 bottom-6 w-[300px] flex flex-col gap-4 z-30">
              ...
              <div className="py-2 pl-2 pr-4 bg-white/1 border border-white/5 rounded-full">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/70 text-sm font-medium">{currentScenarioData.pov}</span>
              ...
              <div className="flex-1 flex flex-col gap-10 px-4 py-6 border border-white/5 rounded-2xl">
                <div className="flex flex-col gap-4">
                  <h3 className="text-white/70 text-sm font-medium pl-2">Channels</h3>
                ...
                {/* DMs Section */}
                <div className="flex flex-col gap-4">
                  <h3 className="text-white/70 text-sm font-medium pl-2">Direct Messages</h3>
                  <div className="space-y-2">
                    {currentTeamMembers.map((member) => (
                      ...
                      >
                        <div className={`w-6 h-6 rounded-full border ${member.borderColor} ${member.bgColor}`}></div>
          ...
          >
            ...
            {isReady && (
              <ChatDemoFull
                ...
                userColors={currentTeamMembers.reduce((acc, member) => {
                  acc[member.name] = {
          ...
          {!isMobile && showContextPanel && (
            <div className="absolute right-6 top-6 bottom-6 w-[380px] flex flex-col justify-between bg-white/5 border border-white/10 px-4 pt-14 pb-4 rounded-2xl z-30">
              ...
              >
                <CloseIcon size={16} color="#DBDBDB" />
              </div>

              <div className="space-y-6">
                {/* Context Content */}
                <div>
                  <h3 className="text-white/80 text-lg font-semibold mb-3">Decision Context</h3>
                  <div className="space-y-3">
                    <div>
                      <div className="text-white/80 text-sm font-medium mb-1">Chosen Path</div>
                      <div className="text-white/60 text-sm">Option C - Targeted campaign approach</div>
                    </div>
                    <div>
                      <h4 className="text-white/70 text-sm font-medium mb-1">Pros</h4>
                    ...
                    <div>
                      <h4 className="text-white/70 text-sm font-medium mb-1">Success Metric</h4>
                      <div className="text-white/50 text-sm">Track conversion rates and cost per acquisition</div>
                    </div>
                  </div>
                </div>
          ...
          {isMobile && isMobileMenuOpen && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur">
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-white/70 text-sm font-medium mb-4">Channels</h3>
                    <div className="space-y-2">
                      {currentChannels.map((channel, index) => (
                        <div
                          key={channel}
                  ...
                  <div>
                    <h3 className="text-white/70 text-sm font-medium mb-4">Team Members</h3>
                    <div className="space-y-2">
                      {currentTeamMembers.map((member) => (
                        <div
                          key={member.name}
          ...
          {isMobile && isMobileCanvasOpen && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm">
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <span className="text-white text-lg font-semibold">Canvas</span>
                  <button
                    onClick={handleMobileCanvasToggle}
                    className="w-8 h-8 flex items-center justify-center text-white/70"
                  >
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-white/80 text-lg font-semibold mb-3">Decision Context</h3>
                    <div className="text-white/60 text-sm mb-4">Option C - Targeted campaign approach</div>
                    <div className="space-y-4">
                      <div>
                        <h4 className="text-white/70 text-sm font-medium mb-2">Success Metric</h4>
                        <div className="text-white/50 text-sm">Track conversion rates and cost per acquisition</div>
                      </div>
                    </div>
                  </div>
